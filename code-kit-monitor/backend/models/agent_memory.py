...
MEMORY_TYPES = ["preference", "fact", "conversation", "context"]
...
class AgentMemory(Base):
    ...
    memory_type: Mapped[str] = mapped_column(String(32), nullable=False, default="fact")  # preference/fact/conversation/context
