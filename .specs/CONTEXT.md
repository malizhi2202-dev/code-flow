...
| 债项 | 来源 | 首次发现 | 影响 | 计划处理 |
|---|---|---|---|---|
| 无业务测试文件（Vitest 已配置但 0 个测试） | 2026-07-03 intel-scan | 2026-07-03 | 重构/新增功能无回归保护 | 下一个 change 应补测试 |
| Schema 迁移无 Alembic（裸 `create_all`） | 2026-07-03 intel-scan | 2026-07-03 | 生产环境改表风险高 | code-kit-monitor change 引入 Alembic |
| 无 lint/format 工具配置（ESLint/Prettier/Ruff 全缺） | 2026-07-03 intel-scan | 2026-07-03 | 代码风格不一致风险 | 低优先级，团队习惯后引入 |
